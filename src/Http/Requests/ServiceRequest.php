...
namespace Litecms\Service\Http\Requests;
...
class ServiceRequest extends FormRequest
{
    ...
    {
        $this->model = $this->route('service');

        if (is_null($this->model)) {
            // Determine if the user is authorized to access service module,
    ...
    {
        return user()->canDo('service.service.view');
    }
}

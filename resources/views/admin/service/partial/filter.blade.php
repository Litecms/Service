<div class="btn-group service-service">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[title]" class="col-sm-2 control-label">
                                        {!! trans('service::service.label.title')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[icon]" class="col-sm-2 control-label">
                                        {!! trans('service::service.label.icon')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[icon]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[heading]" class="col-sm-2 control-label">
                                        {!! trans('service::service.label.heading')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[heading]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            </div>
...
$(document).ready(function(){
    ...
    $(".service-service .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/service.service.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".service-service .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.service-service .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'service.service.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#service-service-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#service-service-list .btn-reset-filter').css('display', 'none');
